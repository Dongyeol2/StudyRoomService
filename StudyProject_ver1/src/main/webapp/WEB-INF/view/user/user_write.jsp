            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        ...
                        <form method="" class="register-form" id="register-form">
                            ...
                            <div class="form-group">
								...
								<input type="text" placeholder="Your ID" style="width:150" id="userid"  name="userid" value="${user.userid}">
								<font color="red"><form:errors path="user.userid" /></font>
								<button class="form-group form-button"  class="form-submit"  type="button" class="idCheck">중복 확인</button>
								<p class="result">
									<span class="msg"></span>
								</p>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="userpwConfirm"><i class="zmdi zmdi-lock-outline"></i></label>
								<input type="password" placeholder="Repeat your password" style="width:150" name="userpwConfirm" id="userpwCheck" onkeyup="checkPwd()">
						    	<span id="checkPwd"></span>
                            </div>
                            <div class="form-group">
                                <label for="email"><i class="zmdi zmdi-email"></i></label>
								<input type="text" id="email" placeholder="Your Email" style="width:240" name="email" value="${user.email}">
                    ...
                    <div class="signup-image">
                        <figure><img src="../images/logo.png" alt="logo_StudyHeaven"></figure>
                        <a href="${pageContext.request.contextPath}/login.do" class="signup-image-link">I am already member</a>
                    </div>
                </div>
            </div>
        </section>
